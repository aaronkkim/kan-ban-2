...
export default {
    ...
    actions: {
        login(e, p) {
            debugger
            api.post('https://ar-ganize-2.herokuapp.com/login',{
                email: e,
                password: p
            }) 
            .then(res => {
        ...
        register(n,e,p){  api.post('https://ar-ganize-2.herokuapp.com/register',{
                name: n,
                email: e,
                password: p
            }) 
        ...
        authenticate(){
            api.get('https://ar-ganize-2.herokuapp.com/authenticate')
            .then(res =>{
                if(res.data.data){
                    state.activeUser=res.data.data
                     this.getBoards()
        ...
        logout(){
            api.delete('https://ar-ganize-2.herokuapp.com/logout').then(res =>{
                state.activeUser= {}
            })
        },
        getBoards() {
